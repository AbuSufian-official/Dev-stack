...
export let brandColor= "bg-gradient-to-r from-[#ff512f] via-[#e91e63] to-[#9c27b0]"
const App=()=>{
    ...
    <Hero/>
          <div className="w-[95%]  mx-auto px-2">
              <div className="text-center md:text-start">
                  <h2 className=" md:text-start text-[25px] sm:text-3xl md:text-4xl font-extrabold tracking-[-1.5px] text-[#101828] ">
              ...
              <div className="py-7 grid md:grid-cols-4 gap-7 md:gap-3 lg:gap-7">
                  ...
                  <div className="grid sm:grid-cols-2  md:grid-cols-2 lg:grid-cols-3 gap-3 md:col-span-3">
                       ...
                       <Card  techData={techDataa} stackData={stackData} setStackData={setStackData}   />
